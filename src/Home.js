...
function Home() {
  ...
  return (
    <div>
      <div>
        <h1 className="text-center text-4xl sm:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-500 animate-bounce pt-2 pb-3 tracking-wide">
          StreamNest
        </h1>
      ...
      <div id="latestMovies">
        ...
        {isAdvanceSearch === true && AdSearchedArray.length > 0 ? (
          <>
            ...
            >
              {!isAdvanceSearch ? "Enable" : "Disable"} advanced search mode
            </button>
          ...
          <>
            ...
            >
              ...
              {isGoTop ? (
                ...
                >
                            <FontAwesomeIcon
                              className="text-blue-650 mr-1 shadow-lg"
